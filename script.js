            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 2rem;">
                <tr>
                    <td style="width: 60%; border: none; vertical-align: top;">
                        ...
                        <p style="margin: 0; font-size: 11pt;">${pdfText.phone[state.currentLang]}: 0901196093</p>
                        <p style="margin: 0; font-size: 11pt;">${pdfText.companyAddress[state.currentLang]}</p>
                        <p style="margin: 0; font-size: 11pt;">${pdfText.email[state.currentLang]}: doc@tanthuanport.vn</p>
                    </td>
